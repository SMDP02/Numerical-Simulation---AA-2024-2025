...
private:
  ...
  vec _xold;            // Previous position vector (used in moveback()) --> needed by Verlet algorithm
  vec _v;               // Velocity vector

// int dim = which direction
public: // Function declarations
  ...
  vec    getvelocity();                  // Get the velocity vector of the particle (the whole vector)
